...
namespace Knx.ObjectModel
{
    ...
    public static class CompilerExtensions
    {
        ...
        public static IEnumerable<CompilerMessage> Compile(this Function f)
        {
        ...
        public static IEnumerable<Function> GetSubFunctions(this Function f)
        {
            return f.SubFunctions.SelectMany(f1 => f1.GetSubFunctions());
        }

        public static IEnumerable<ComObjectInstance> GetAffectedComObjects(this Function f)
        {
        ...
        public static bool ContainsLoop(this Function f, Function parent = null)
        {
            Function toCompare = parent ?? f;
